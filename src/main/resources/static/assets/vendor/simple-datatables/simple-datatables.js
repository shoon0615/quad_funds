                    ...
                    (function () {
                        ...
                        function p(t, e, s) {
                            ...
                            return "#text" === t.nodeName ? i = s.document.createTextNode(t.data) : "#comment" === t.nodeName ? i = s.document.createComment(t.data) : (e ? i = s.document.createElementNS("http://www.w3.org/2000/svg", t.nodeName) : "svg" === t.nodeName.toLowerCase() ? (i = s.document.createElementNS("http://www.w3.org/2000/svg", "svg"), e = !0) : i = s.document.createElement(t.nodeName), t.attributes && Object.entries(t.attributes).forEach((function (t) {
                                        ...
                                        })), s.valueDiffing && (t.value && u(i, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (i.value = t.value), t.checked && u(i, "HTMLInputElement") && (i.checked = t.checked), t.selected && u(i, "HTMLOptionElement") && (i.selected = t.selected))),
                            i
                        }
                        var f = function (t, e) {
                        ...
                        function m(t, e, s) {
                            ...
                            case s._const.addTextElement:
                                ...
                                if (n = s.document.createTextNode(e[s._const.value]), !(i = f(t, m)).childNodes)
                                    return !1;
                        ...
                        function S(t, e) {
                            ...
                            if (u(t, "Text", "Comment"))
                                ...
                                if (t.childNodes && t.childNodes.length > 0)
                                    s.childNodes = [], Array.prototype.slice.call(t.childNodes).forEach((function (t) {
                        ...
                        R = function (t, e) {
                            ...
                            return t.replace(k, (function (r, l) {
                                    ...
                                    if (d) {
                                        ...
                                        var g = a[n - 1];
                                        g && s.node.nodeName && (g.node.childNodes || (g.node.childNodes = []), g.node.childNodes.push(s.node)),
                                        a[n] = s
                                    }
                        ...
                        H = function () {
                            function t(t, e, s) {
                                ...
                                this.diffcount = 0,
                                this.foundAll = !1,
                                this.debug && (this.t1Orig = "undefined" != typeof Element && u(t, "Element") ? S(t, this.options) : "string" == typeof t ? R(t, this.options) : JSON.parse(JSON.stringify(t)), this.t2Orig = "undefined" != typeof Element && u(e, "Element") ? S(e, this.options) : "string" == typeof e ? R(e, this.options) : JSON.parse(JSON.stringify(e))),
                                this.tracker = new V
                            }
                            ...
                            t.prototype.findDiffs = function (t, e) {
                                ...
                                do {
                                    ...
                                    0 === (s = this.findNextDiff(t, e, [])).length && (D(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0, N(t), s = this.findNextDiff(t, e, [])))),
                            ...
                            t.prototype.findNextDiff = function (t, e, s) {
                                ...
                                if (this.options.maxDepth && s.length > this.options.maxDepth)
                                    return [];
                                if (!t.outerDone) {
                                    if (i = this.findOuterDiff(t, e, s), this.options.filterOuterDiff && (n = this.options.filterOuterDiff(t, e, i)) && (i = n), i.length > 0)
                            ...
                            t.prototype.findOuterDiff = function (t, e, s) {
                                ...
                                for (n = t.attributes ? Object.keys(t.attributes).sort() : [], a = e.attributes ? Object.keys(e.attributes).sort() : [], o = n.length, l = 0; l < o; l++)
                                    i = n[l], -1 === (r = a.indexOf(i)) ? d.push((new h).setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i])) : (a.splice(r, 1), t.attributes[i] !== e.attributes[i] && d.push((new h).setValue(this.options._const.action, this.options._const.modifyAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.oldValue, t.attributes[i]).setValue(this.options._const.newValue, e.attributes[i])));
                                for (o = a.length, l = 0; l < o; l++)
                                    i = a[l], d.push((new h).setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]));
                                return d
                            },
                                        ...
                                        if (!0 === u[w])
                                            if ("#text" === (l = f[w]).nodeName)
                                                if ("#text" === m[v].nodeName) {
                                                    ...
                                                    b.push((new h).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)), u.splice(w, 1), f.splice(w, 1), g = Math.min(u.length, p.length), w -= 1, v -= 1;
                                            ...
                                            "#text" === (l = m[v]).nodeName ? (b.push((new h).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)), u.splice(w, 0, !0), f.splice(w, 0, {
                                                    nodeName: "#text",
                                                    data: l.data
                        ...
                        class nt {
                            ...
                            bindEvents() {
                                ...
                                this.options.contextMenu && (this.events.context = this.context.bind(this), this.events.updateMenu = this.updateMenu.bind(this), this.events.dismissMenu = this.dismissMenu.bind(this), this.events.reset = function (t, e = 300) {
                                    let s;
                                    return (...i) => {
                                        clearTimeout(s),
                        ...
                        exports.convertJSON = function (s) {
                            ...
                            if (n.data.length || t(n.data)) {
                                ...
                                if (t ? (i = {
                                            ...
                                            }))) : console.warn("That's not valid JSON!"), i)
                                    return i
                            }
                            return !1
                        },
